...
namespace SchoolManagment3.DAL
{
    class DataAccessLayer
    {
        ...
        //public static string con = @"Data Source = .\SQLEXPRESS; Initial Catalog=SchoolManagment2017; Integrated Security=True";
        public static string con = @"Data Source = (LocalDB)\MSSQLLocalDB; AttachDbFilename= |DataDirectory|GestionEco.mdf; Integrated Security=True";
        //public static string con = $@"; Initial Catalog=SchoolManagment2017; Integrated Security = true";

...
namespace SchoolManagment3.BL
{
    class Class_Users
    {
        ...
        public static int usp_tblUsersInsert(string username, string fullname, string password, string email)
        {
            DataAccessLayer.Open();
        ...
        public static int usp_tblUsersUpdate(string username, string fullname, string password, string email)
        {
            DataAccessLayer.Open();
